...
export default function ChatMessage({
    ...
    const [isTyping, setIsTyping] = useState(!isUser && !safeMessage.skipTyping); // Only type for AI messages
        ...
        >
            ...
            <div className={`flex gap-3 max-w-[80%] ${isUser ? "flex-row-reverse" : "flex-row"}`}>
                ...
                <motion.div
                    ...
                    className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center border-2 ${isUser
