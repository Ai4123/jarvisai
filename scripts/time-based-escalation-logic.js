// Node: Check Chat Duration and Add Ticket Prompt if Needed
// Insert this BEFORE "Code in JavaScript7" (the normal response node)
...
const data = {
    ...
    chat_id,
    duration_minutes: Math.round(durationMinutes * 10) / 10, // Round to 1 decimal
